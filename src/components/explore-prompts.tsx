...
const examplePrompts = [
    {
        ...
        imageUrl: 'https://storage.googleapis.com/gemini-studio-assets/explore/underwater_v2.jpg',
        hint: 'underwater kingdom',
    },
    {
        title: 'Cyberpunk Metropolis',
        prompt: 'Futuristic cityscape with neon lights and advanced technology',
        imageUrl: 'https://storage.googleapis.com/gemini-studio-assets/explore/cyberpunk_v2.jpg',
        hint: 'cyberpunk metropolis',
    },
    {
        title: 'Enchanted Forest',
        prompt: 'Ancient woodland with mystical creatures and magical atmosphere',
        imageUrl: 'https://storage.googleapis.com/gemini-studio-assets/explore/forest_v2.jpg',
    ...
    },
    {
        ...
        imageUrl: 'https://storage.googleapis.com/gemini-studio-assets/explore/steampunk_v2.jpg',
        hint: 'steampunk city',
    },
    {
        title: 'Cosmic Dream',
        prompt: 'A surreal landscape of swirling nebulae, distant galaxies, and floating crystalline structures.',
        imageUrl: 'https://storage.googleapis.com/gemini-studio-assets/explore/cosmic_v2.jpg',
        hint: 'cosmic dream',
    },
    {
        ...
        imageUrl: 'https://storage.googleapis.com/gemini-studio-assets/explore/temple_v2.jpg',
